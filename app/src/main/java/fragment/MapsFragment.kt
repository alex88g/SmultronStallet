...
//        mMap.addMarker(MarkerOptions().position(location1).title("IT-Högskolan Stockholm")
//            .snippet("En bland de högst rekommenderade skolor"))
//
        val stockholm = LatLng(59.30696, 18.03324)
        val zoomLevel = 15f

        mMap.addMarker(MarkerOptions().position(stockholm).title("Brödernas"))
